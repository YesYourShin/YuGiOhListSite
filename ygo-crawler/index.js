...
const url = 'http://yugioh.wikia.com/api.php';
const conditions = '&conditions=Japanese%20kana%20name::%2B';
...
const fetchCardList = async (offset, limit) => {
    const response = await axios.get(
        ...
        `http://yugioh.wikia.com/api.php?action=askargs&conditions=Japanese%20kana%20name::%2B&printouts=Japanese%20name|Page%20name&parameters=&format=json&api_version=3`
    );
